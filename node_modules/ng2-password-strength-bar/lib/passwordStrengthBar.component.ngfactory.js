...
var styles_PasswordStrengthBarComponent = ['ul#strengthBar[_ngcontent-%COMP%] {\n      display: inline;\n      list-style: none;\n      margin: 0 0 0 15px;\n      padding: 0;\n      vertical-align: 2px;\n    }\n\n    ul#strengthBar[_ngcontent-%COMP%]   .point[_ngcontent-%COMP%] {\n      background: #DDD;\n      border-radius: 2px;\n      display: inline-block;\n      height: 5px;\n      margin-right: 1px;\n      width: 20px;\n    }\n    \n    ul#strengthBar[_ngcontent-%COMP%]   .point[_ngcontent-%COMP%]:last-child {\n      margin: 0;\n    }'];
...
var View_PasswordStrengthBarComponent0 = (function (_super) {
    ...
    View_PasswordStrengthBarComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_6 = import3.createRenderElement(this.renderer, this._el_1, 'ul', new import3.InlineArray2(2, 'id', 'strengthBar'), null);
    ...
    View_PasswordStrengthBarComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_20 = import3.inlineInterpolate(1, '', this.context.barLabel, '');
        if (import3.checkBinding(throwOnChange, this._expr_20, currVal_20)) {
            this.renderer.setText(this._text_4, currVal_20);
            this._expr_20 = currVal_20;
        }
        var currVal_21 = this.context.bar0;
        if (import3.checkBinding(throwOnChange, this._expr_21, currVal_21)) {
            this.renderer.setElementStyle(this._el_8, 'background-color', ((this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_21) == null) ? null : this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_21).toString()));
            this._expr_21 = currVal_21;
        }
        var currVal_22 = this.context.bar1;
        if (import3.checkBinding(throwOnChange, this._expr_22, currVal_22)) {
            this.renderer.setElementStyle(this._el_10, 'background-color', ((this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_22) == null) ? null : this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_22).toString()));
            this._expr_22 = currVal_22;
        }
        var currVal_23 = this.context.bar2;
        if (import3.checkBinding(throwOnChange, this._expr_23, currVal_23)) {
            this.renderer.setElementStyle(this._el_12, 'background-color', ((this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_23) == null) ? null : this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_23).toString()));
            this._expr_23 = currVal_23;
        }
        var currVal_24 = this.context.bar3;
        if (import3.checkBinding(throwOnChange, this._expr_24, currVal_24)) {
            this.renderer.setElementStyle(this._el_14, 'background-color', ((this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_24) == null) ? null : this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_24).toString()));
            this._expr_24 = currVal_24;
        }
        var currVal_25 = this.context.bar4;
        if (import3.checkBinding(throwOnChange, this._expr_25, currVal_25)) {
            this.renderer.setElementStyle(this._el_16, 'background-color', ((this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_25) == null) ? null : this.viewUtils.sanitizer.sanitize(import9.SecurityContext.STYLE, currVal_25).toString()));
